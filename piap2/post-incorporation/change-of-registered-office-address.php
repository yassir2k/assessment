...
$('#print').click(function()
	 {
		 if( ($('#rcno').val()=="") || ($('#custId').val()=="") || ($('#company').val()=="") || ($('#post_llc_changeOfName_resDate').val()=="") ||         ($('#officers').val()=="") || ($('#current').val()=="") || ($('#proposed').val()==""))
		 {
	...
	$('#verify').click(function()
	 {
		 ...
		 else
		 {
			 ...
			 if(result > 14)
			 {
				 var elapsed = parseInt(result) - 14;
				 var officers = $('#officers').val();
				 var penalty = (1 + 1 + parseInt(officers)) * (50 * elapsed);
				 $('#penalty').val(penalty);
			 }
			 else
			 {
...
<td align="left">
<input type="text" id="rcno" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input type="text" id="current" style="width:250px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input type="text" id="proposed" style="width:250px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input type="text" id="officers" style="width:100px;" maxlength="100"/>
</td>
</tr>
