...
<br />
<h1 id='disp' align="center" style="display: none;font-family: Calligrapher;font-size: 45px; ">
Corporate Affairs Commission</h1>
...
<td align="right">
<input type="text" id="current" style="width:350px;" maxlength="150"/>
</td>
</tr>
...
<td align="right">
<input type="text" id="proposed" style="width:350px;" maxlength="150"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" placeholder="3000" type="text" id="ctc" style="background-color:#eee; color:red; width:200px;" maxlength="100"/>
</td>
</tr>
