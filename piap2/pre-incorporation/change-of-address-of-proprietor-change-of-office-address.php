...
<title>Change Of Registration Address Of Proprietor/Change Of Office Address</title>
...
Change Of Registration Address Of Proprietor/Change Of Office Address
</legend>
...
<td align="left">
    <label>
      <input type="checkbox" name="cbox" value="bn" id="bnBox" />
      Change Of Registration Address Of Proprietor
   </label>
</td>
<td align="right">
<input type="text" value="1000" id="change-proprietor" style="font-family:cambria; background-color:#f5f5f5; color:#900" readonly="readonly" />
</td>
</tr>
...
<td align="left">
    <label>
      <input type="checkbox" name="change-office" value="branch-add" id="change-office" />
      Change Of Office Address
   </label>
</td>
<td align="right">
<input type="text" value="2000" name="total-due" style="font-family:cambria; background-color:#f5f5f5; color:#900" readonly="readonly" />
</td>
</tr>
...
<td align="left">
<input type="text" name="bn_payable" style="font-family:cambria; background-color:#f5f5f5; font-weight:bold; color:#900" readonly="readonly" />
</td>
</tr>
