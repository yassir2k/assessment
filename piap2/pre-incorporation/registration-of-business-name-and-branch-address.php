...
<title>Registration Of Business Name & Branch Address</title>
...
Registration Of Business Name& Branch Address
</legend>
...
<td align="right">
<input type="text" value="4000" name="bn_amount" style="font-family:cambria; background-color:#f5f5f5; color:#900" readonly="readonly" />
</td>
</tr>
...
<td align="left">
    <label>
      <input type="checkbox" name="cbox" value="branch-add" id="branchBox" />
      Branch Address
   </label>
</td>
<td align="right">
<input type="text" value="1000" name="bn_branch" style="font-family:cambria; background-color:#f5f5f5; color:#900" readonly="readonly" />
</td>
</tr>
