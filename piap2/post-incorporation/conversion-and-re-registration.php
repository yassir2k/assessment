...
<title>Conversion & Re-Registration</title>
...
<br />
<form action="conversion-and-re-registration.php" method="post">
...
<td align="right">
<input type="text" id="rcno" name="rcno" style="width:200px;" maxlength="10" onkeypress="return isNumberKey(event)" />
</td>
</tr>
...
<td align="right"><input type="text" id="custId" name="custId" style="width:200px;" maxlength="20"/></td>
</tr>
...
<td align="right">
<input type="text" id="company" name="company" style="width:200px;" maxlength="200"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" type="text" id="post_llc_changeOfName_resDate" name="resDate" style="width:185px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly"  type="text" id="filing" name="filling" style="background-color:#eee; color:red; width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly"  type="text" id="penalty" name="penalty" style="background-color:#eee; color:red; width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" value="" type="text" id="total" name="total" style="background-color:#eee; color:red; width:200px;" maxlength="100"/>
</td>
</tr>
...
<input type="submit" style="color:#333; font-family:cambria;" value="Print" id="print" name="print" />
</td>
</tr>
</table>
</fieldset>
