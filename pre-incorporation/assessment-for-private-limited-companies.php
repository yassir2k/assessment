...
<title>Assessment For Private Limited Companies (LLC)</title>
...
Assessment For Private Companies (LLC)
</legend>
...
<td align="left">
<input readonly="readonly" style="background-color:#eee;" name="pre-llc-code" type="text" id="pre-llc-code" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-llc-cust-id" type="text" id="pre-llc-cust-id" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-llc-avail-code" type="text" id="pre-llc-avail-code" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-llc-appr-name" type="text" id="pre-llc-appr-name" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" name="pre-llc-comp-type" type="text" id="pre-llc-comp-type" value="LLC" 
...
<td align="right">
<input name="pre-llc-sh-cap" type="text" id="pre-llc-sh-cap" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" name="pre-llc-date" type="text" id="pre-llc-date" style="width:185px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-llc-stat-fee" type="text" id="pre-llc-stat-fee" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-llc-charge-ctc" type="text" id="pre-llc-charge-ctc" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-llc-total" type="text" id="pre-llc-total" style="width:200px;" maxlength="100"/>
</td>
</tr>
