...
<title>Assessment For Public Limited Companies (PLC)</title>
...
Assessment For Public Limited Companies (PLC)
</legend>
...
<td align="left">
<input readonly="readonly" style="background-color:#eee;" name="pre-plc-code" type="text" id="pre-plc-code" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-plc-cust-id" type="text" id="pre-plc-cust-id" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-plc-avail-code" type="text" id="pre-plc-avail-code" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-plc-appr-name" type="text" id="pre-plc-appr-name" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" name="pre-plc-comp-type" type="text" id="pre-plc-comp-type" value="PLC" 
style="background-color:#eee; width:50px;" maxlength="100"/>
</td>
</tr>

<tr>
<td align="left">
Share Capital (In Naira):
</td>
<td align="right">
<input name="pre-plc-sh-cap" type="text" id="pre-plc-sh-cap" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" name="pre-plc-date" type="text" id="pre-plc-date" style="width:185px;" maxlength="100"/>
</td>
</tr>
...
<td align="right">
<input name="pre-plc-stat-fee" type="text" id="pre-plc-stat-fee" style="width:200px;" maxlength="100"/>
</td>
</tr>

<tr>
<td align="left">
Charge For CTC (In Naira):
</td>
<td align="right">
<input name="pre-plc-charge-ctc" type="text" id="pre-plc-charge-ctc" style="width:200px;" maxlength="100"/>
</td>
</tr>

<tr>
<td align="left">
Total Amount Due (In Naira):
</td>
<td align="right">
<input name="pre-plc-total" type="text" id="pre-plc-total" style="width:200px;" maxlength="100"/>
</td>
</tr>

<tr>
<td align="right">
<input type="button" style="color:#333; font-family:cambria;" value="Verify" />
</td>
<td align="left">
