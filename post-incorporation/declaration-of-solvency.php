...
<title>Declaration of Solvency</title>
...
<link href="../css/dcmegamenu.css" rel="stylesheet" type="text/css" />
	...
	$(function() {
		$( "#post_llc_changeOfName_resDate_" ).datepicker({
			changeMonth: true,
			changeYear: true
		});
	});
	...
	$('#print').click(function()
	 {
         if( ($('#rcno').val()=="") || ($('#custId').val()=="") || ($('#company').val()=="") || ($('#post_llc_changeOfName_resDate').val()=="") 
		  || ($('#post_llc_changeOfName_resDate_').val()==""))
		 {
...
<td align="left">
<input name="rcno" type="text" id="rcno" style="width:200px;" onkeypress="return isNumberKey(event)" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input name="custId" type="text" id="custId" style="width:200px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" type="text" name="post_llc_changeOfName_resDate" id="post_llc_changeOfName_resDate" style="width:185px;" maxlength="100"/>
</td>
</tr>
...
<td align="left">
<input readonly="readonly" type="text" id="post_llc_changeOfName_resDate_" style="width:185px;" maxlength="100"/>
</td>
</tr>
